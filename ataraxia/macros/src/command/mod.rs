    ...
    fn permissions_to_tokens(
        ...
        match perms {
            Some(perms) => {
                ...
                syn::parse_quote! { #(ataraxia::serenity_prelude::Permissions::#perms)|* }
            }
            None => syn::parse_quote! { ataraxia::serenity_prelude::Permissions::empty() },
        }
    }
...
fn generate_command(mut inv: Invocation) -> Result<proc_macro2::TokenStream, darling::Error> {
    ...
    Ok(quote::quote! {
        ...
        #function_visibility fn #function_name() -> ::ataraxia::Command<
            <#ctx_type_with_static as ataraxia::_GetGenerics>::U,
            <#ctx_type_with_static as ataraxia::_GetGenerics>::E,
        > {
            #function
            ...
            ::ataraxia::Command {
                ...
                cooldowns: std::sync::Mutex::new(::ataraxia::Cooldowns::new(::ataraxia::CooldownConfig {
